...
**Today's Progress:** 
1. Nearly finished design for Home Page - moving into functionality after implementing task btns

**Thoughts:** Really had to make myself code for the hour today, but I'm glad I was able to make some changes and review more of the project I'm using for reference. 
...
### Day 18: August 15, 2023

**Today's Progress:** 
1. Focused on plugging in Task Data, to be continued and tested

**Thoughts:** EJS is quite lovely. Stays very close to vanilla javascript in comparison to other frameworks, while providing the convenience of the other frameworks. 
...
### Day 20: August 17, 2023

**Today's Progress:** 
1. Determined Task styling & did a little testing.

**Thoughts:** Checkbox styling is wayyy more time consuming and bigger of a challenge than I wanted it to be. 
...
### Day 22: August 19, 2023

**Today's Progress:** 
1. Updated routes for new login feature
2. Began implementation of login - worked on routing & file structure. Login form to be continued

**Thoughts:** Getting excited again about the apps progress. I can feel myself becoming more confident and familiar with app development, which is a big relief. Always enjoy the little serotonin boost when new code functions as expected.
...
**Today's Progress:** 
1. Finished "Add Task" functionality.
2. Created Delete & Edit Icons - styled accordingly. 

**Thoughts:** I'm enjoying how quick I'm getting at CSS. A quick 15-30 minute side-quest of fitting in two icons onto the Task items amidst the functionality being implemented is a great way to satisfy my ADD itches. 
...
**Thoughts:** Early AM dashboard update before a fun day with my partner and friends. What a good Saturday
